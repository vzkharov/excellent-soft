...
const styles = tv({
	slots: {
		section: "relative text-center overflow-hidden flex flex-col items-center justify-center gap-10 rounded-md bg-onyx py-24 md:py-36 after:absolute after:bottom-0 after:h-px after:w-full after:max-w-screen-md after:bg-primary after:content-['']",
