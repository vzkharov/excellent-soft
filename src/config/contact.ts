...
const contactConfig = {
	instagram: { id: 'instagram', name: 'Instagram', img: '/social-media/instagram.png', href: '', value: '' },
	behance: { id: 'behance', name: 'Behance', img: '/social-media/behance.png', href: '', value: '' },
	telegram: { id: 'telegram', name: 'Telegram', img: '/social-media/telegram.png', href: '', value: '' },
	whatsapp: { id: 'whatsapp', name: 'WhatsApp', img: '/social-media/whatsapp.png', href: '', value: '' },
